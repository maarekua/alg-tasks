function sumOfLastNumbers (numbers) {
  ...
  console.log(numbers.reduce(((sum, el) => {
    return sum + +String(el).slice(-1)}), 0))
}
...
function mersennePrime (number) {
  const mersennePrimeNumbers = [3, 7, 31, 127, 8191, 131071, 524287, 2147483647, 2305843009213693951, 618970019642690137449562111, 162259276829213363391578010288127, 170141183460469231731687303715884105727]
...
function numberLengthSum (number) {
  ...
  console.log(`Number length: ${arrayNumbers.length}, Number sum: ${numberSum}`)
}
...
function numberFunction (number) {
  ...
  const replaceNumbers = stringNumber.slice(-1) + stringNumber.slice(1, -1) + stringNumber[0];
